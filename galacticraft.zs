...
recipes.addShaped(<GalacticraftCore:tile.airLockFrame:1> * 1, [
  [compressedSteel, compressedSteel, compressedSteel],
  [<ore:plateMeteoricIron>, waferBasic, <ore:plateMeteoricIron>],
  [compressedSteel, compressedSteel, compressedSteel]] ) ;
recipes.remove(<GalacticraftCore:item.sensorLens> );
recipes.addShaped(<GalacticraftCore:item.sensorLens> * 1, 
  [[<minecraft:redstone>, <minecraft:glass_pane>, <minecraft:redstone>],
  [<minecraft:glass_pane>, <ore:plateMeteoricIron>, <minecraft:glass_pane>],
  [<minecraft:redstone>, <minecraft:glass_pane>, <minecraft:redstone>]]);
recipes.remove(<GalacticraftCore:item.engine:1> );
recipes.addShaped( <GalacticraftCore:item.engine:1> * 1,
  [[<ore:plateMeteoricIron>, <minecraft:wool:4>, <ore:plateMeteoricIron>],
  [<ore:plateMeteoricIron>, <GalacticraftCore:item.fuelCanisterPartial:1>, <ore:plateMeteoricIron>],
  [plateHeavyDuty, <GalacticraftCore:item.airVent>, plateHeavyDuty]]); 
recipes.remove(<GalacticraftCore:tile.machineTiered:12>);
recipes.addShaped(<GalacticraftCore:tile.machineTiered:12> * 1,
  [[plateHeavyDuty, plateHeavyDuty, plateHeavyDuty],
  [plateHeavyDuty, <GalacticraftCore:tile.machineTiered:4>, plateHeavyDuty],
  [<ore:ingotMeteoricIron>, waferAdvanced, <ore:ingotMeteoricIron> ]]);
recipes.remove(<GalacticraftMars:item.null:6>);
recipes.addShaped(<GalacticraftMars:item.null:6> * 1, 
  [[<ore:ingotMeteoricIron>, <GalacticraftCore:item.airFan>  , <ore:ingotMeteoricIron>],
  [<minecraft:slime_ball>, waferAdvanced, <minecraft:slime_ball>],
  [<ore:ingotMeteoricIron>, <GalacticraftCore:item.airFan>  , <ore:ingotMeteoricIron>]  ]);     
recipes.remove(<GalacticraftCore:item.sensorGlasses>);
recipes.addShaped(<GalacticraftCore:item.sensorGlasses> * 1,
  [[<minecraft:string>, <ore:gemDiamond>, <minecraft:string>],
  [<minecraft:string>, null, <minecraft:string>],
  [<GalacticraftCore:item.sensorLens>, <ore:ingotMeteoricIron>, <GalacticraftCore:item.sensorLens>]]);
recipes.remove(<GalacticraftCore:tile.spinThruster>);
recipes.addShaped(<GalacticraftCore:tile.spinThruster> * 1,
[[<GalacticraftCore:item.fuelCanisterPartial:1>, waferAdvanced, <GalacticraftCore:item.engine>],
[compressedSteel, <ore:ingotMeteoricIron>, compressedSteel]]   ) ;
